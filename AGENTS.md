...
Never log browser push endpoints, push keys, or subscription credentials. Browser push ownership-transition logs may include only safe, non-credential metadata.
